//! Specifications for PartyEmail aggregate
//!
...
// Each predicate implements `Specification<PartyEmail>` and can be combined
...
//
// pub struct ActivePartyEmailSpec;
// impl Specification<PartyEmail> for ActivePartyEmailSpec {
//     fn is_satisfied_by(&self, e: &PartyEmail) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
