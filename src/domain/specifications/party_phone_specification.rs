//! Specifications for PartyPhone aggregate
//!
...
// Each predicate implements `Specification<PartyPhone>` and can be combined
...
//
// pub struct ActivePartyPhoneSpec;
// impl Specification<PartyPhone> for ActivePartyPhoneSpec {
//     fn is_satisfied_by(&self, e: &PartyPhone) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
