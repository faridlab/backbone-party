//! Specifications for PartyContact aggregate
//!
...
// Each predicate implements `Specification<PartyContact>` and can be combined
...
//
// pub struct ActivePartyContactSpec;
// impl Specification<PartyContact> for ActivePartyContactSpec {
//     fn is_satisfied_by(&self, e: &PartyContact) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
