//! Specifications for Party aggregate
//!
...
// Each predicate implements `Specification<Party>` and can be combined
...
//
// pub struct ActivePartySpec;
// impl Specification<Party> for ActivePartySpec {
//     fn is_satisfied_by(&self, e: &Party) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
