//! Specifications for PartyAddress aggregate
//!
...
// Each predicate implements `Specification<PartyAddress>` and can be combined
...
//
// pub struct ActivePartyAddressSpec;
// impl Specification<PartyAddress> for ActivePartyAddressSpec {
//     fn is_satisfied_by(&self, e: &PartyAddress) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
